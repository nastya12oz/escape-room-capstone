...
export const getBookingPlaces = (state: Pick<State, NameSpace.Booking>): BookingQuest[] | null => state[NameSpace.Booking].bookingPlaces;
...
export const getSelectedPlace = (state: Pick<State, NameSpace.Booking>): BookingQuest | null => state[NameSpace.Booking].selectedPlace;
